...
# main config
PLUGINSLUG="blockquote-cite"
CURRENTDIR=`pwd`
MAINFILE="fergcorp-blockquote-cite.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/blockquote-cite" # Remote SVN repo on wordpress.org, with no trailing slash
